...
- **Sheldon Krasowski**, *No Surrender: The Land Remains Indigenous* (University of Regina Press, 2019) — argues that Indigenous leaders never agreed to cede land in the Numbered Treaties; treaties were sharing agreements, not surrenders; Crown commissioners systematically omitted the surrender clause from oral negotiations. Read via Stelter review (*Ontario History* 112:2, 2020); full book not held.
- **Elizabeth McKenzie and Ian Mosby**, "Reconciling the Ledger: The Rupert's Land Purchase, Settler Capitalism, and Indigenous Dispossession on the Prairies," *Journal of the Canadian Historical Association* 34:1 (2024): 105–139 — the macro cost-side frame for this project. Core argument: prairie settler capitalism was built directly upon Indigenous dispossession in ways that can be quantified in stolen land and money. The article compares what the HBC received through the Rupert's Land Purchase with what First Nations received through Treaties 1–7 and Métis through the Manitoba Act, in quantitative and qualitative terms.
  - **Key figures:** HBC received 6.6 million acres of prime agricultural land + £300,000 cash; CPR received 25 million acres; First Nations received only ~3 million acres in reserves through Treaties 1–7 — less than half the HBC grant, and likely less than their per-capita treaty entitlement. HBC land sales netted ~$96 million net profit (1891–1930; ~$2 billion today). 874,000 acres officially "surrendered" from reserves nationally, 1871–1928 — the national universe containing this project's 54 Saskatchewan parcels. Métis scrip: 1.4 million acres promised; most went to white scrip speculators.
  - **Saskatchewan-specific (via Beal, cited by McKenzie/Mosby):** ~380,000 acres removed from Saskatchewan reserves 1898–1928 — a 25% decline in total First Nations land holdings in the province. DIA sold surrendered reserve lands for $1–$1.50/acre while HBC rarely sold farmlands for less than $10/acre; DIA also took a cut of up to 90% (50% after 1906) before the remainder reached band funds. Of $3.2M in DIA surrender revenue in Saskatchewan 1898–1930, over $893,000 (>25%) resulted from Soldier Settlement Act appropriations post-1917.
  - **Quality, not just quantity:** First Nations were consistently restricted from choosing the best lands (fertile river lots near developing towns and railways); those went to HBC and settlers. McKenzie/Mosby show HBC's Manitoba grant was 59% Class 1 and 29% Class 2 land; First Nations ended up with swampy, isolated, marginal lands — the Cree words for reserves: *askîhkân* ("fake land") and *iskonikan* ("left-overs").
  - **Terminology note:** McKenzie and Mosby themselves put "surrenders" in scare quotes ("so-called surrenders," p. 281), consistent with this project's position on the term. This is a useful precedent — two settler academics in a major CHA journal modelling the same terminological stance — if the thesis framing needs to be defended.
  - **Relevance to this project:** McKenzie/Mosby document the macro cost side that this project does not analyze. This project contributes the bottom-up mechanism analysis — the settler pressure, petition cycles, and railway corridors that drove individual land takings — within the structural framework McKenzie/Mosby describe. Cite them for national-scale context; cite Beal (via McKenzie/Mosby) for the Saskatchewan-specific 380,000-acre figure.
  - **Follow-up — Carl Beal:** McKenzie/Mosby cite Beal extensively for the Saskatchewan-specific numbers but his work appears in their footnotes as unpublished research. If a primary quantitative source is needed for the provincial picture (acreage, sale prices, Soldier Settlement Act share), Beal should be tracked down directly.
  - **Follow-up — quality argument and spatial data:** McKenzie/Mosby's argument that reserves were pushed onto marginal land while fertile land near towns and railways went to HBC and settlers raises a question worth exploring: whether the spatial data in this project contains anything bearing on land quality (soil class, proximity to water, elevation, or similar). If such data exists or can be joined, it could strengthen the case study analysis — the remaining reserve land after partial takings was often the only good land adjacent to towns, which helps explain continued settler pressure. This is speculative until the data is checked; flag for consideration at the case study stage.
...
**Terminology note — "surrender":**
The Indian Act designated these transactions as "surrenders," and DIA administrative records use this term throughout — which means it is embedded in the primary evidentiary base. Krasowski demonstrates that Indigenous peoples did not understand themselves to be surrendering or ceding title; the treaties were sharing agreements, and oral negotiations omitted the surrender clause. Using "surrender" unqualified is therefore complicity with a colonial framing that misrepresents what Indigenous nations consented to.

Planned approach for thesis write-up: introduce the legal-administrative definition of "surrender" once in the conceptual chapter, cite Krasowski, and then use alternative language throughout. The closest candidate for replacement language is **"land taking"** (names the act and its agent, avoids the consent implication). **"Dispossession"** is already load-bearing in the theoretical frame but is too broad — it names the macro outcome, not the specific Indian Act mechanism. **"Forced transfer"** is accurate but clinical. The right term is still being considered; the analysis stage does not require the final choice.

**Etymology and legal meaning of "surrender":** The word derives from Old French *surrendre* — *sur-* (over) + *rendre* (to give back). In British property law it acquired a precise technical meaning, codified by Blackstone in *Commentaries on the Laws of England* (Book II, 1766): "a yielding up of an estate for life or years to him that has the immediate reversion or remainder, wherein the particular estate may merge or drown, by mutual agreement between them" (p. 203). Blackstone gives it a Latin name: *sursumredditio* — "upward-rendering." For copyhold manorial land, he is more explicit still: "the yielding up of the estate by the tenant into the hands of the lord" (p. 232). Both definitions share a structural logic — the *lesser* estate falls into the *greater*. The surrenderor must already be in possession as a *tenant*; the surrenderee must hold a *higher* estate. Surrender is therefore not a neutral transaction: it presupposes a feudal hierarchy in which the surrendering party holds only a subordinate interest in land whose superior title already belongs to someone else.

Applying this vocabulary to Indigenous land embeds two colonial fictions as preconditions before any transaction occurs: (1) that Indigenous peoples held only a subordinate, tenant-like interest in their own lands, and (2) that the Crown already held the superior title to which that interest could be returned. The word does not merely describe what happened — it presupposes the entire colonial legal fiction of Crown sovereignty and Indigenous subordination.

This presupposition hardened over time. Borrows reconstructs the Royal Proclamation of 1763 not as a unilateral Crown declaration but as part of a bilateral treaty confirmed at Niagara in 1764, within which First Nations understood the terms to include "consent to land surrender" alongside sovereignty, alliance, and trade — a framework of public, consensual purchase, not unilateral taking (Borrows, "Wampum at Niagara," pp. 160, 170). The Indian Act surrender mechanism systematically subverted that consent framework: by the numbered treaty era "surrender" had become boilerplate, embedded in a cumulative chain of synonyms — Treaty No. 6 (1876) reads "cede, release, surrender and yield up to the Government of the Dominion of Canada... all their rights, titles and privileges" — each term added to close potential legal gaps, with adhesion texts adding "transfer" and "relinquish" to the stack. The proliferation of terms suggests the Crown's own legal drafters were uncertain whether "surrender" alone was sufficient.

The stakes of the terminology are clarified by Slattery's analysis of aboriginal title: in dealing with "the character of surrenders of native land, and the fiduciary obligations of the Crown toward native peoples," Slattery shows that "surrender to the Crown" is specifically the mechanism of *extinguishment* of aboriginal title (Brian Slattery, "Understanding Aboriginal Rights," *Canadian Bar Review* 66 [1985]: 739). Title is "inalienable except by surrender to the Crown" — quoting the Privy Council in *Star Chrome* — and Hall J. in *Calder* held that Indian title "could not thereafter be extinguished except by surrender to the Crown or by competent legislative authority, and then only by specific legislation" (Slattery, pp. 749, 750). "Surrender" in this framework does not merely describe a conveyance; it describes the permanent termination of prior rights. This is Blackstone's *sursumredditio* logic carried to its colonial conclusion: the lesser estate does not just yield to the greater — it is extinguished by it.

Borrows documents the interpretive counter. Indigenous nations at Niagara and in the treaty negotiations "did not consider their sovereignty extinguished" by these transactions; they understood them as sharing agreements (Borrows, p. 157). This is consistent with Krasowski's finding that Crown commissioners omitted the surrender clause from oral negotiations entirely. The legal vocabulary and the Indigenous understanding of the same events were systematically divergent — and "surrender" encodes the Crown's interpretation, not a shared reality.

The government did not deliberately select a loaded term. It inherited "surrender" from existing British colonial legal vocabulary — the Rupert's Land Act (1868) and the Deed of Surrender (1870) used it to describe the HBC's relinquishment of its charter rights, and the Indian Act extended the same language to reserve land. But inheritance is not innocence: applying a term that encodes feudal English property law to transactions Indigenous peoples understood as sharing agreements was itself a colonial act, whether intentional or not. "Surrender" also carries its military meaning — yielding to a conqueror — which compounds the problem further. McKenzie and Mosby (2024) signal the same discomfort with scare quotes around "so-called surrenders" in a major CHA journal (p. 281); this project follows the same terminological logic.

Draft disclaimer for conceptual chapter: "The Indian Act designated these transactions as 'surrenders.' I use that term only when referring to the legal-administrative mechanism. Throughout this thesis, I use [X] to describe what actually occurred, because 'surrender' implies a willing, informed relinquishment of title that Krasowski and Indigenous oral tradition demonstrate did not take place."
